...
class IntExpression(Visitable):
    def __init__(self, value: int):
        self.value = value

class FloatExpression(Visitable):
    def __init__(self, value: float):
        self.value = value
    
class StringExpression(Visitable):
...
class CreateColumnDefinition():
    def __init__(self, column_name = None, column_type:ColumnType = None, varchar_length:int = None, is_pk: bool = False):
        self.column_name = column_name
        self.column_type = column_type
        self.varchar_length = varchar_length if column_type == ColumnType.VARCHAR else None
        self.is_pk = is_pk
...
class CreateIndexStatement(Statement):
    def __init__(self, index_name: str, table_name: str, column_name: str, index_type: IndexType):
...
class InsertStatement(Statement):
    def __init__(self, table_name: str, values: list[Visitable]):
        self.table_name = table_name
        self.values = values
# endregion
